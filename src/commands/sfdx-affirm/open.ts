...
export default class Open extends SfdxCommand {
    ...
    public async run(): Promise<AnyJson> {
        ...
        const username = await verifyUsername(this.flags.targetusername, (verbose == true ? this.ux : undefined));
        const orgIsSandbox: boolean = await sfdxGetIsSandbox(username, (verbose == true ? this.ux : undefined));
        ...
        const response: AnyJson = await sfdxOpenToPath(username, path, this.flags.urlonly, (verbose == true ? this.ux : undefined));
